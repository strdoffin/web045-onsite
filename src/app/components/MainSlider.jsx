...
export default function MainSlider() {
    ...
    return (
        <div className="relative w-full max-w-5xl mx-auto mt-32 rounded-lg overflow-hidden shadow">
            {/* Slide Image with Fade Animation */}
            <img
                src={images[current].src}
                alt={images[current].alt}
                className={`w-full h-[450px] sm:h-[400px] object-cover object-center transition-opacity duration-500 ${
